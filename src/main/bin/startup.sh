...
CANAL_OPTS="-Dloader.path=$loader_path -DappName=canal_rabbitmq_clickhouse_sync -Dlogback.configurationFile=$logback_configurationFile"
MAIN_JAR=$base/lib/canal-rabbitmq-clickhouse-sync-*.jar
